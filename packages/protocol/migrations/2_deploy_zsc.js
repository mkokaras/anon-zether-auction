...
var AUC = artifacts.require("Auction");

module.exports = (deployer) => {
  return Promise.all([
    deployer.deploy(CashToken),
    deployer.deploy(InnerProductVerifier, { gas: 6721975 }).then(() =>
      Promise.all([
        deployer.deploy(ZetherVerifier, InnerProductVerifier.address, {
          gas: 6721975,
        }),
    ...
    .then(() => deployer.deploy(AUC, ZSC.address));
};
