...
contract ZSC {
    ...
    mapping(bytes32 => address) locked; // main account mapping
    mapping(bytes32 => address) pLocked; // storage for pending transfers
    ...
    function unlock(Utils.G1Point memory y) public {
        ...
        require(checkLock(yHash,msg.sender),"You cant operate");
